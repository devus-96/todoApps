...
export const Form = () => { 
        ...
        try {
            ...
            setError(err)
    ...
    }} className="bg-white w-[380px] absolute left-1/2 translate-x-[-50%] px-8 pt-2 pb-8 space-y-8 mt-4 rounded-2xl">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-4">Already have an account ? <Link href='/login' className="text-blue-400 underline ">login</Link></p>
                    </div>
            </form>
}